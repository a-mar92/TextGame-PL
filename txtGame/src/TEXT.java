public class TEXT {
    ...
    static String[] lazienkaStart = {"ok idę do łazienki",
            ".....",
            "od razu lepiej :)"};
    ...
    static String[] lazienkaOpis = {"-ŁAZIENKA-","Jeseteś w dużej ładnej łazience, szafki, pralka, płytki, wszystko jest na swoim miejscu",
            "na blacie przy umywalce widziasz opakowanie tabletek przeciwbólowych oraz kubek  "};
    static String[] lazienkaMenu ={
            "1 - Zabierz tabletki   ",
            "2 - Zabierz Kubek  ",
